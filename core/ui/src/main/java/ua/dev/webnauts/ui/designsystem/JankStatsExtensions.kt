...
package ua.dev.webnauts.ui.designsystem
...
/**
 * Удобная функция для работы с состоянием [PerformanceMetricsState], которое необходимо очистить.
 * Побочный эффект перезапускается, если какое-либо из значений [keys] не равно предыдущему составу.
 */
@Composable
...
/**
 * Отслеживайте рывки при прокрутке всего, что можно прокручивать.
 * */
@Composable
